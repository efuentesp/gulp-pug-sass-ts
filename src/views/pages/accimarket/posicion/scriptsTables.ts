...
const respuestaServicio = (tabla: string, tablaTotal: string, payload: any) => {
  ...
  var jsonTotales =
    '[{"contrato": "","emisora": "Posicion Total","inversion": "' +
    sumInversion +
    '","valor": "' +
    sumValor +
    '","porInv": "' +
    sumPorInv +
    '"},{"contrato": "","emisora": "Efectivo","inversion": "","valor": "' +
    sumValor +
    '","porInv": ""},{"contrato": "","emisora": "RF","inversion": "' +
    sumInversion +
    '","valor": "' +
    sumValor +
    '","porInv": ""}]';
  ...
  $("#dialogMovimi").click(() => {
    ...
    http_findAll("consultaCon", mov_pos_dialog_params, payload => {
      if (payload !== null) {
        ...
        $("#table_detalle").jqGrid("setGridParam", {
          data: payload.movimientosLst
        });
